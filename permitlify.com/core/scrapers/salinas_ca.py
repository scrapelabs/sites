"""Salinas CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.salinas_ca \\
...
CFG = CityConfig(
    ...
    city       = 'Salinas',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/MONTEREY/Cap/CapHome.aspx?module=Building&TabName=Home',
)
