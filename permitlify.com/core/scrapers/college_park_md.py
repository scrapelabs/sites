"""College Park MD — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.college_park_md \\
...
CFG = CityConfig(
    ...
    city       = 'College Park',
    state      = 'MD',
    url        = 'https://aca-prod.accela.com/collegepark/Default.aspx',
)
