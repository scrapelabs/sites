"""Anaheim CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.anaheim_ca \\
...
CFG = CityConfig(
    ...
    city       = 'Anaheim',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/ANAHEIM/Cap/CapHome.aspx?module=Building',
)
