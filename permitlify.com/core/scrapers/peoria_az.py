"""Peoria AZ — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.peoria_az \\
...
CFG = CityConfig(
    ...
    city       = 'Peoria',
    state      = 'AZ',
    url        = 'https://aca-prod.accela.com/PEORIA/Cap/CapHome.aspx?module=Building&TabName=HOME',
)
