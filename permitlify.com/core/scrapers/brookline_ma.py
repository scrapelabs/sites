"""Brookline MA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.brookline_ma \\
...
CFG = CityConfig(
    ...
    city       = 'Brookline',
    state      = 'MA',
    url        = 'https://aca-prod.accela.com/BROOKLINE/Cap/CapHome.aspx?module=Building',
)
