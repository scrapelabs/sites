"""Bakersfield CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.bakersfield_ca \\
...
CFG = CityConfig(
    ...
    city       = 'Bakersfield',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/KERNCO/Cap/CapHome.aspx?module=Building&TabName=Home',
)
