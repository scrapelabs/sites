"""Cambridge MA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.cambridge_ma \\
...
CFG = CityConfig(
    ...
    city       = 'Cambridge',
    state      = 'MA',
    url        = 'https://aca-prod.accela.com/BPHC/Cap/CapHome.aspx?module=Permits',
)
