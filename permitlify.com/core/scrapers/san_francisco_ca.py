"""San Francisco CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.san_francisco_ca \\
...
CFG = CityConfig(
    ...
    city       = 'San Francisco',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/SFPORT/Cap/CapHome.aspx?module=Building&TabName=Home',
)
