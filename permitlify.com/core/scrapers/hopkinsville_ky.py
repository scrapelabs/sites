"""Hopkinsville KY — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.hopkinsville_ky \\
...
CFG = CityConfig(
    ...
    city       = 'Hopkinsville',
    state      = 'KY',
    url        = 'https://aca-prod.accela.com/HOPKINSVILLE/Cap/CapHome.aspx?module=Building',
)
