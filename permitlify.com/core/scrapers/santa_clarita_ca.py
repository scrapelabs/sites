"""Santa Clarita CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.santa_clarita_ca \\
...
CFG = CityConfig(
    ...
    city       = 'Santa Clarita',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/SANTACLARA/Cap/CapHome.aspx?module=Building&TabName=Home',
)
