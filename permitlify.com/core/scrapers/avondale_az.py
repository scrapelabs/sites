"""Avondale AZ — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.avondale_az \\
...
CFG = CityConfig(
    ...
    city       = 'Avondale',
    state      = 'AZ',
    url        = 'https://aca-prod.accela.com/AVONDALE/Cap/CapHome.aspx?module=Engineering&TabName=Home',
)
