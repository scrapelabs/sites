"""Lawrence KS — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.lawrence_ks \\
...
CFG = CityConfig(
    ...
    city       = 'Lawrence',
    state      = 'KS',
    url        = 'https://aca-prod.accela.com/ljcmg/Cap/CapHome.aspx?module=Building&TabName=Home',
)
