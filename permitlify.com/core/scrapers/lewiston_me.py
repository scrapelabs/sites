"""Lewiston ME — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.lewiston_me \\
...
CFG = CityConfig(
    ...
    city       = 'Lewiston',
    state      = 'ME',
    url        = 'https://aca-prod.accela.com/ljcmg/Cap/CapHome.aspx?module=Building&TabName=Building',
)
