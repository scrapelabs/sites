"""Santa Rosa CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.santa_rosa_ca \\
...
CFG = CityConfig(
    ...
    city       = 'Santa Rosa',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/santarosa/Cap/CapHome.aspx?module=Building&TabName=Building',
)
