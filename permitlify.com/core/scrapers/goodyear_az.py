"""Goodyear AZ — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.goodyear_az \\
...
CFG = CityConfig(
    ...
    city       = 'Goodyear',
    state      = 'AZ',
    url        = 'https://aca-prod.accela.com/GOODYEAR/customization/common/home.aspx',
)
