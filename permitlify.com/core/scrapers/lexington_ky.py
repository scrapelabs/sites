"""Lexington KY — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.lexington_ky \\
...
CFG = CityConfig(
    ...
    city       = 'Lexington',
    state      = 'KY',
    url        = 'https://aca-prod.accela.com/LEXKY/Cap/CapHome.aspx?module=Building&TabName=Home',
)
