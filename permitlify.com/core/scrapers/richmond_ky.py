"""Richmond KY — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.richmond_ky \\
...
CFG = CityConfig(
    ...
    city       = 'Richmond',
    state      = 'KY',
    url        = 'https://aca-prod.accela.com/RICHMOND/Cap/CapHome.aspx?module=Building&TabName=Home',
)
