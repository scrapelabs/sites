"""Worcester MA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.worcester_ma \\
...
CFG = CityConfig(
    ...
    city       = 'Worcester',
    state      = 'MA',
    url        = 'https://aca-prod.accela.com/BPHC/Cap/CapHome.aspx',
)
