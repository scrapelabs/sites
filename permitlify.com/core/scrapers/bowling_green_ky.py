"""Bowling Green KY — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.bowling_green_ky \\
...
CFG = CityConfig(
    ...
    city       = 'Bowling Green',
    state      = 'KY',
    url        = 'https://aca-prod.accela.com/LJCMG/Cap/CapHome.aspx?module=Building',
)
