"""San Bernardino CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.san_bernardino_ca \\
...
CFG = CityConfig(
    ...
    city       = 'San Bernardino',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/SBC/Cap/CapHome.aspx?module=Building&TabName=Home',
)
