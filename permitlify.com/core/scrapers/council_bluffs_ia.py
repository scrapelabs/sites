"""Council Bluffs IA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.council_bluffs_ia \\
...
CFG = CityConfig(
    ...
    city       = 'Council Bluffs',
    state      = 'IA',
    url        = 'https://aca-prod.accela.com/COF/Cap/CapHome.aspx',
)
