"""Tempe AZ — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.tempe_az \\
...
CFG = CityConfig(
    ...
    city       = 'Tempe',
    state      = 'AZ',
    url        = 'https://aca-prod.accela.com/TEMPE/Cap/CapHome.aspx?module=Building',
)
