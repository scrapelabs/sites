"""Davenport IA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.davenport_ia \\
...
CFG = CityConfig(
    ...
    city       = 'Davenport',
    state      = 'IA',
    url        = 'https://aca-prod.accela.com/POLKCO/Cap/CapHome.aspx?module=Building',
)
