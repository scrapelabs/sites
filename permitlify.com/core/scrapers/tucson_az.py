"""Tucson AZ — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.tucson_az \\
...
CFG = CityConfig(
    ...
    city       = 'Tucson',
    state      = 'AZ',
    url        = 'https://aca-prod.accela.com/PIMA/Cap/CapHome.aspx?module=Building',
)
