"""Hagerstown MD — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.hagerstown_md \\
...
CFG = CityConfig(
    ...
    city       = 'Hagerstown',
    state      = 'MD',
    url        = 'https://aca-prod.accela.com/WASHCOMD/Cap/CapHome.aspx?module=Building',
)
