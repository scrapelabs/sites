"""Frederick MD — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.frederick_md \\
...
CFG = CityConfig(
    ...
    city       = 'Frederick',
    state      = 'MD',
    url        = 'https://aca-prod.accela.com/FREDERICK/Cap/CapHome.aspx?module=Building&TabName=Home',
)
