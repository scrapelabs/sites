"""Baltimore MD — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.baltimore_md \\
...
CFG = CityConfig(
    ...
    city       = 'Baltimore',
    state      = 'MD',
    url        = 'https://aca-prod.accela.com/BALTIMORE/Cap/CapHome.aspx?module=Building&TabName=Home',
)
