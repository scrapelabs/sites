"""Fontana CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.fontana_ca \\
...
CFG = CityConfig(
    ...
    city       = 'Fontana',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/FONTANA/Cap/CapHome.aspx?module=Planning&TabName=Home',
)
