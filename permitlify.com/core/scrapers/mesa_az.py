"""Mesa AZ — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.mesa_az \\
...
CFG = CityConfig(
    ...
    city       = 'Mesa',
    state      = 'AZ',
    url        = 'https://aca-prod.accela.com/MESA/Cap/CapHome.aspx?module=Permits&TabName=Permits',
)
