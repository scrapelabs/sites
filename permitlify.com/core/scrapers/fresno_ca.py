"""Fresno CA — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.fresno_ca \\
...
CFG = CityConfig(
    ...
    city       = 'Fresno',
    state      = 'CA',
    url        = 'https://aca-prod.accela.com/FRESNO/Cap/CapHome.aspx?module=Planning',
)
