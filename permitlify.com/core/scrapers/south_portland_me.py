"""South Portland ME — standalone Accela permit-scraper bot.
...
Run from the shell::
    ...
    DJANGO_DEBUG=1 python -m core.scrapers.south_portland_me \\
...
CFG = CityConfig(
    ...
    city       = 'South Portland',
    state      = 'ME',
    url        = 'https://aca-prod.accela.com/COSP/Cap/CapHome.aspx?module=Building',
)
