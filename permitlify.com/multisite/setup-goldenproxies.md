...
| Code folder    | `C:\Users\Administrator\Desktop\github\goldenproxies.com`      |
...
```
cd C:\Users\Administrator\Desktop\github\permitlify.com
git pull
multisite\setup_caddy.bat
```
...
Place the site's code in a folder **next to** `permitlify.com`:
...
`C:\Users\Administrator\Desktop\github\goldenproxies.com`.)
...
```
cd C:\Users\Administrator\Desktop\github\permitlify.com
multisite\new_site.bat GoldenProxies C:\Users\Administrator\Desktop\github\goldenproxies.com 8001
```
...
```
C:\Users\Administrator\Desktop\github\permitlify.com\multisite\Caddyfile
```
...
| Caddy not answering                       | `nssm restart Caddy`, then check `permitlify.com\multisite\caddy.err.log`.            |
